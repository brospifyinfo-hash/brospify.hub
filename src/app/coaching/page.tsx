      ...
      <div className="min-h-screen bg-mesh">
        ...
        <div className="max-w-xl mx-auto px-4 py-16">
          ...
          >
            ...
            <h1 className="text-lg font-bold">{t.coaching.lockedTitle}</h1>
            <p className="text-[12px] text-zinc-400 mt-2 leading-relaxed">
              {t.coaching.lockedDesc}
            </p>
            <button
        ...
        >
          <div className="p-4 flex items-center gap-3 flex-wrap">
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-sm font-bold">{t.coaching.whatsappTitle}</h2>
              <p className="text-[11px] text-zinc-400 leading-snug">
                {t.coaching.whatsappDesc}
              </p>
            </div>
            {waLink ? (
              <a
              ...
              >
                ...
                {t.coaching.whatsappWrite}
              </a>
            ) : (
              <span className="text-[10px] text-zinc-500 shrink-0">
                {t.coaching.whatsappSoon}
              </span>
            )}
          </div>
        </motion.div>
        ...
        <div className="space-y-2">
          ...
          {tips.length === 0 && (
            <div className="glass-strong rounded-xl p-6 border border-white/10 text-center">
              ...
              <h2 className="text-sm font-bold mb-1">{t.coaching.noTips}</h2>
              <p className="text-xs text-zinc-500">{t.coaching.noTipsDesc}</p>
            </div>
          )}
