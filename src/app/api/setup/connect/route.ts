...
export async function POST(req: NextRequest) {
  try {
    ...
    const scopes = "read_products,write_products,read_themes,write_themes,read_content,write_content,write_legal_policies,read_files,write_files,read_orders,read_customers";
