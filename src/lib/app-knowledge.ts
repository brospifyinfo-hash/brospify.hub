...
- NEU: Auf [Theme](/themes) wählt man im "Fertiges Produkt-Theme"-Bereich ZUERST das Produkt, dann die Optik: 12 fertige STILE (Modern, Elegant, Bold, Verspielt, Minimal, Noir/dunkel, Sunset, Ocean, Nature, Candy, Tech, Royal). Jeder Stil bringt nicht nur eigene Farben/Schriften/Ecken mit, sondern auch eine eigene ANORDNUNG der Kaufbox-Bausteine, andere ein-/ausgeblendete Bausteine/Sektionen und eine eigene Design-Ausprägung (Schatten, Randstärke, Icon-Stil). Ein "Zufall"-Button würfelt alles neu. Danach kann man Farben (5 Rollen), Überschriften-/Text-Schrift, Ecken (Slider 0–40 px) sowie das Design (Schatten Aus/Weich/Stark, Rand Dünn/Dick, Icons Dunkel/Akzent/Umriss) einzeln feinjustieren. Eine große Live-Vorschau zeigt die ganze Produktseite (Kaufbox: Dringlichkeit, Titel, Bewertung, Vorteile, Lager, Preis, Bundle-Auswahl, Kaufen-Button, Zahlarten, Gratis-Geschenk, Timeline — plus darunter die Sektionen Produktdetails, Marken-Story, Video-Bewertungen, Bewertungen, Weitere Produkte) und aktualisiert sich SOFORT. Über der Vorschau gibt es einen PC/Handy-Umschalter (Desktop 2-spaltig / Handy 1-spaltig). Im Section-Manager kann man pro Sektion per Schalter entscheiden, ob sie angezeigt wird, UND ihre Überschrift bearbeiten. Zusätzlich lassen sich die einzelnen KAUFBOX-BAUSTEINE (Angebots-Hinweis, Titel, Bewertung, Vorteile, Lager, Varianten-Auswahl, Preis, Mengen-Bundles, Kaufen-Button, Zahlarten, Gratis-Geschenk, Liefer-Timeline, Trennlinie, Freitext, FAQ-Klappbereich) frei sortieren (hoch/runter) und einzeln ein-/ausblenden — einige (Varianten, Trennlinie, Freitext, FAQ) sind standardmäßig aus und können zugeschaltet werden. Die Vorteile-Icons sind frei wählbar: für jeden der 4 Vorteile kann man aus einer Icon-Bibliothek (Versand, Rückgabe, Sicherheit, Qualität, Geschenk, Herz, Blitz, Uhr u. v. m.) ein Symbol wählen — das landet auch im Download. Der Editor ist in aufklappbare Gruppen gegliedert (Stil, Farben, Schriften & Ecken, Design, Vorteile-Icons, Kaufbox-Bausteine, Sektionen) — übersichtlich, immer nur das Nötige offen. All das landet auch im heruntergeladenen Theme (Reihenfolge/Sichtbarkeit der Bausteine + ausgeblendete Sektionen werden übernommen). Die Einstellungen stehen auf dem PC links, die Vorschau groß rechts. Leere Texte sind mit Beispiel-Verkaufstexten gefüllt (nie rohe Platzhalter). Der Download liefert dann das vollständige Shopify-Theme (Start- + Produktseite, alle Sections) mit Stil und gewählten Einstellungen.
