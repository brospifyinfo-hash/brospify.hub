...
- NEU: Auf [Theme](/themes) kann man im "Fertiges Produkt-Theme"-Bereich einen STIL wählen (Modern, Elegant, Bold, Verspielt) — jeder Stil bringt andere Farben, Schriften, Ecken/Abstände und blendet andere Sections ein/aus, sodass das Theme komplett anders aussieht. Danach lassen sich Farben (5 Rollen), Überschriften- und Text-Schrift einzeln feinjustieren. Eine Live-Vorschau (echtes Theme-Layout, erste Sections) zeigt jede Änderung sofort.
