...
- NEU: Auf [Theme](/themes) kann man im "Fertiges Produkt-Theme"-Bereich einen STIL wählen (Modern, Elegant, Bold, Verspielt), dann Farben (5 Rollen), Überschriften-/Text-Schrift und Ecken (Kantig/Leicht/Rund) anpassen. Eine Live-Vorschau zeigt SOFORT an einer sauberen Produkt-Ansicht (Mockup mit echtem Produktbild + Texten), wie sich die Einstellungen auswirken. Wichtig: Die Vorschau ist eine Vorschau der EINSTELLUNGEN, nicht 1:1 das fertige Theme — der Download liefert das vollständige Shopify-Theme mit allen Sections, Stil und gewählten Einstellungen.
