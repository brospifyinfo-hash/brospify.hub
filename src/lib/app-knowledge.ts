...
- Viral Video Scout — [Viral Video Scout](/video-scout): findet zu einem Produkt die viralsten echten TikTok-Videos (echte View-Counts, sortiert nach Klicks). Man WÄHLT eines seiner bereits im Produkt-Drop gezogenen Produkte aus (kein Freitext) und die gewünschte Anzahl (3, 6 oder 9 Videos). Wer noch nichts gezogen hat, zieht zuerst im [Produkt Search](/charts). Kosten: 40 (3 Videos) / 70 (6) / 90 (9) Credits. Nur eindeutig zum Produkt passende Videos werden gezeigt; gibt es weniger passende, kommen entsprechend weniger zurück (es wird nicht mit irrelevanten aufgefüllt). Wurden keine passenden gefunden, werden KEINE Credits abgezogen. Gut für Ad-Inspiration und Creative-Research.
