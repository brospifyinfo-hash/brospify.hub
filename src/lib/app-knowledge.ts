...
- NEU: Auf [Theme](/themes) wählt man im "Fertiges Produkt-Theme"-Bereich ZUERST das Produkt, dann die Optik: 12 fertige STILE (Modern, Elegant, Bold, Verspielt, Minimal, Noir/dunkel, Sunset, Ocean, Nature, Candy, Tech, Royal), ein "Zufall"-Button würfelt Stil + Akzentfarbe + Schriften + Ecken neu, und man kann Farben (5 Rollen), Überschriften-/Text-Schrift sowie Ecken (Slider 0–40 px) einzeln feinjustieren. Eine große Live-Vorschau zeigt die ganze Produktseite (Kaufbox: Dringlichkeit, Titel, Bewertung, Vorteile, Lager, Preis, Bundle-Auswahl, Kaufen-Button, Zahlarten, Gratis-Geschenk, Timeline — plus darunter die Sektionen Produktdetails, Marken-Story, Video-Bewertungen, Bewertungen, Weitere Produkte) und aktualisiert sich SOFORT. Über der Vorschau gibt es einen PC/Handy-Umschalter (Desktop 2-spaltig / Handy 1-spaltig). Im Section-Manager kann man pro Sektion per Schalter entscheiden, ob sie angezeigt wird, UND ihre Überschrift bearbeiten — beides landet auch im heruntergeladenen Theme (ausgeblendete Sektionen werden im Theme deaktiviert). Die Einstellungen stehen auf dem PC links, die Vorschau groß rechts. Leere Texte sind mit Beispiel-Verkaufstexten gefüllt (nie rohe Platzhalter). Der Download liefert dann das vollständige Shopify-Theme (Start- + Produktseite, alle Sections) mit Stil und gewählten Einstellungen.
