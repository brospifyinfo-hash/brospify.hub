...
- NEU (v2): Der [Theme-Editor](/themes/editor) ist ein vollwertiger Editor mit umgekehrtem Ablauf: SCHRITT 1 ist die Produkt-Wahl aus einem Bilder-Grid der eigenen gezogenen Produkte — Vorschau und Theme werden automatisch mit Bild & Daten dieses Produkts befüllt. Danach öffnet sich der Split-Pane-Editor (Desktop: Aufbau links, große Live-Vorschau in der Mitte, Inspector rechts; Handy: gestapelt). 12 STILE (Modern, Elegant, Bold, Verspielt, Minimal, Noir, Sunset, Ocean, Nature, Candy, Tech, Royal) bringen jeweils eine EIGENE SEITEN-ARCHITEKTUR mit: andere Sections in anderer Reihenfolge mit anderen Style-Arten — plus eigene Farben/Schriften/Kaufbox-Anordnung/Design. "Zufall" würfelt alles neu. SECTION-BIBLIOTHEK: Über "+"-Punkte direkt in der Vorschau oder den "Section hinzufügen"-Button öffnet sich eine Bibliothek mit ~20 Section-Typen in 5 Kategorien (Verkauf: CTA-Banner, Countdown, Produkt-Empfehlungen, Kategorie-Badges · Social Proof: Kunden-Bewertungen, Bewertungs-Übersicht, Bewertungs-Marquee, Video-Bewertungen, Social-Leiste · Inhalt: Feature-Grid, Marken-Story/Bild+Text, Spalten-Grid, Text-Statement · Medien: Parallax-Bild, Collage, Video, Lauftext · Info: FAQ Premium, Aufklapp-Inhalte, Produktdetails-Tabs). Die Bibliothek ist eine auswählbare GALERIE mit großem PREVIEW-FENSTER: links die Section-Liste nach Kategorien, rechts eine große Live-Vorschau der markierten Section mit eigenem Produktbild und aktuellen Farben; Style-Arten wechselt man als Chips direkt im Preview, eingefügt wird per Button. STIL NACHTRÄGLICH ÄNDERN: Der Button "Stil-Galerie" oben in der Leiste (und im Inspector) öffnet jederzeit eine Galerie aller 12 Stile mit großer Vorschau der Stil-Architektur. Beim Anwenden wählt man: "Nur Design übernehmen" (Farben, Schriften, Ecken, Galerie-Look — eigener Seitenaufbau und alle Texte bleiben erhalten) oder "Kompletten Stil anwenden" (baut Produkt- und Startseite nach dem Stil neu, eigene Anpassungen gehen verloren). JEDE Section hat mehrere STYLE-ARTEN (z. B. Marken-Story: 50/50 Split, Editorial Overlap, Minimalist Center; Produkt-Empfehlungen: Galerie, Editorial, Slider), die Layout/Spalten/Bildformat wirklich verändern. Klick auf eine Section (in Vorschau oder Aufbau) öffnet rechts den Inspector: Style-Art wechseln, Texte bearbeiten (Überschriften, FAQ-Fragen/Antworten, CTA-Texte …), hoch/runter schieben, entfernen. KAUFBOX (die Produktinfo-Spalte neben dem Produktbild) ist voll gestaltbar: 23 Baustein-Typen (u. a. Sale-Banner, Angebots-Hinweis, Titel, Sterne-Bewertung, Vorteile-Liste, Lager-Hinweis, Varianten, Mengen-Auswahl, Preis, Mengen-Bundles, Kaufen-Button, Zahlarten, Gratis-Geschenk, Liefer-Timeline, Feature-Boxen, Vertrauens-Icons, Produktbeschreibung, Trennlinie, Freitext, FAQ, Aufklapp-Tab, Passende Produkte, Teilen) — sortieren, ein-/ausblenden, und JEDER Baustein hat eigene STYLE-ARTEN (z. B. Bundles: Modern/Soft/Umriss/Klassisch · Kaufen-Button: Klassisch/XL/Express-Combo mit PayPal+Klarna · Sterne: Klassisch/Pill/Glow · Vorteile: Dunkle/Akzent/Soft/Umriss-Kreise) plus editierbare Texte. Ein Klick auf einen Baustein in der Vorschau öffnet direkt seine Einstellungen. Auch die PRODUKTGALERIE (Bild + Thumbnails) hat Style-Arten: Thumbnails unten / Thumbnails links / Portrait mit Bild-Zähler / Kino-Slider mit Autoplay — plus optionales Badge auf dem Hauptbild. Ohne Auswahl zeigt der Inspector das globale Design (Stil, 5 Farben, Schriften, Ecken-Slider 0–40 px, Schatten/Rand/Icon-Stil). UNDO/REDO über Buttons oder Ctrl+Z / Ctrl+Shift+Z. PC/Handy-Umschalter über der Vorschau. STIL NACHTRÄGLICH ÄNDERN: Oben in der Leiste gibt es den Button "Stil-Galerie" — 12 Stile mit großer Live-Vorschau. Beim Anwenden wählt man: "Nur Design übernehmen" (Farben/Schriften/Ecken/Galerie-Look — eigener Seitenaufbau und alle Texte bleiben) oder "Kompletten Stil anwenden" (baut beide Seiten neu, eigene Anpassungen gehen verloren). SECTION-GALERIE: Das Hinzufügen von Sections öffnet eine Galerie mit GROSSEM Preview-Fenster — links die Liste nach Kategorien, rechts die große Live-Vorschau der markierten Section mit eigenem Produktbild; Style-Arten als Chips umschaltbar, dann "Section einfügen". DESIGNS SPEICHERN & CODES: Über den Button "Designs" speichert man beliebig viele benannte Speicherstände pro Produkt. JEDES Design hat einen EIGENEN Sync-Code (bspx_…), der in der Liste immer sichtbar ist und per Klick kopiert wird. Live-Design im Shop WECHSELN: einfach den Code eines anderen Designs in Shopify im Block "Brospify Dynamic Buybox" ins Feld "Brospify Sync-Code" einfügen — ohne neues ZIP. "Laden" holt einen Speicherstand zurück in den Editor, "Aktualisieren" überschreibt ihn mit dem aktuellen Stand (und pusht damit auch das Live-Design), Löschen entfernt nur den Speicherstand (Shops mit dem Code behalten ihr Design). Download und "Live aktualisieren" nutzen automatisch den Code des gerade aktiven Designs. Alles kostenlos. STARTSEITE: Links oben im Aufbau-Panel gibt es einen Seiten-Umschalter "Produktseite | Startseite" — die Startseite (Hero-Slider, Vorteil-Banner, Foto-Kollage, Standort-Karte + alle anderen Bibliotheks-Sections) lässt sich genauso bearbeiten: umsortieren, entfernen, neue Sections mit Style-Arten einfügen, Texte ändern. Übernommene Startseiten-Sections behalten ihren Original-Look, bis man eine Style-Art wählt. ALLES, was man einstellt, landet 1:1 im heruntergeladenen Theme — Sections, Reihenfolge, Style-Arten, Texte, Farben, Schriften, Kaufbox (gleiche Engine für Vorschau und Export; vor dem Download läuft eine automatische Validierung). Die /themes-Seite hat eine große "Theme-Editor öffnen"-Karte als Einstieg.
- PREISE: Theme-Download und Live-Updates sind KOSTENLOS — beliebig oft. Credits kostet NUR die einmalige KI-Text-Erstellung pro Produkt (beim allerersten Download dieses Produkts, Standard 100, Admin-Schlüssel THEME_EXPORT). Sind die KI-Texte für ein Produkt einmal erstellt, sind alle weiteren Downloads/Design-Varianten/Updates gratis.
- LIVE-SYNC (dynamische Buy Box): NUR der Bereich "Produktinformationen" / Kaufbox (Titel, Bewertung, Vorteile, Preis, Varianten, Mengenrabatte, Kaufen-Button, Zahlarten, Liefer-Timeline UND die Farben/Schriften dieser Kaufbox) lädt sich im Shop LIVE vom Hub. Im Theme steckt dafür nur ein Block "Brospify Dynamic Buybox" mit einem Sync-Code (kommt automatisch vorbefüllt mit dem Download — null Einrichtung). WICHTIG — was "Live aktualisieren" kann und was nicht: Ändert der Kunde die KAUFBOX (deren Bausteine, Farben, Schriften, Icons, Bundles) und klickt "Live aktualisieren", erscheint das nach ~1 Minute in ALLEN Shops mit diesem Code (im Shop ggf. einmal neu laden) — ohne neues ZIP. ABER: Die SEKTIONEN (alles über/unter der Kaufbox, die Startseite) und der GLOBALE Look (Seiten-Hintergrund, Farbschemata, Schriften der Sektionen, Bildergalerie) liegen FEST im ZIP. Wenn man den Gesamt-STIL oder Sektionen ändert, muss man das Theme NEU HERUNTERLADEN (kostenlos) und in Shopify hochladen — das wird NICHT live übernommen. Der Kauf läuft 100% über Shopifys eigene Warenkorb-Logik im Shop (der Hub ist am Kauf nie beteiligt). Ist der Hub mal nicht erreichbar, zeigt der Shop das zuletzt geladene Design (Browser-Cache) oder den ins ZIP eingebackenen Plan oder eine einfache eingebaute Kauf-Form — kaufbar bleibt der Shop IMMER. Design-WECHSEL im Shop: einen anderen gespeicherten Design-Code in Shopify im Block "Brospify Dynamic Buybox" ins Feld "Brospify Sync-Code" einfügen. (Technik-Hinweis für Support: Der Storefront-Fetch geht bewusst auf die Apex-Domain brospifyhub.com — der www-Redirect hat keine CORS-Header; die Runtime probiert beide Varianten.)
