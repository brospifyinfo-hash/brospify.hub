...
export const SECTION_LIBRARY: SectionDef[] = [
  ...
  {
    type: "bro-google-reviews",
    category: "social",
    label: "Google-Reviews",
    labelEn: "Google reviews",
    desc: "Bewertungs-Karussell im Google-/Trustpilot-Look: bunte Marken-Headline, Sterne-Score, scrollbare Karten mit Produkt-Label, Avatar und Zitat.",
    ...
    fields: [
      ...
      { id: "tag_1", label: "Karte 1 — Produkt-Label", labelEn: "Card 1 — product label", kind: "text", target: { key: "tag_1" }, def: "Bestseller" },
      { id: "quote_1", label: "Karte 1 — Text", labelEn: "Card 1 — text", kind: "textarea", target: { key: "quote_1" }, def: "Die App mit den geführten Anleitungen ist der Wahnsinn — ich nutze sie täglich." },
      { id: "name_1", label: "Karte 1 — Name", labelEn: "Card 1 — name", kind: "text", target: { key: "name_1" }, def: "Daniel R." },
      { id: "rate_1", label: "Karte 1 — Sterne (1–5)", labelEn: "Card 1 — stars", kind: "text", target: { key: "rate_1" }, def: "5" },
      { id: "tag_2", label: "Karte 2 — Produkt-Label", labelEn: "Card 2 — product label", kind: "text", target: { key: "tag_2" }, def: "Neuheit" },
      { id: "quote_2", label: "Karte 2 — Text", labelEn: "Card 2 — text", kind: "textarea", target: { key: "quote_2" }, def: "Top-Qualität und blitzschnelle Lieferung. Klare Empfehlung von mir!" },
      { id: "name_2", label: "Karte 2 — Name", labelEn: "Card 2 — name", kind: "text", target: { key: "name_2" }, def: "Sammi B." },
      { id: "rate_2", label: "Karte 2 — Sterne (1–5)", labelEn: "Card 2 — stars", kind: "text", target: { key: "rate_2" }, def: "4.5" },
      { id: "tag_3", label: "Karte 3 — Produkt-Label", labelEn: "Card 3 — product label", kind: "text", target: { key: "tag_3" }, def: "Beliebt" },
      { id: "quote_3", label: "Karte 3 — Text", labelEn: "Card 3 — text", kind: "textarea", target: { key: "quote_3" }, def: "Hat meine Erwartungen wirklich übertroffen. So ein gutes Produkt!" },
      { id: "name_3", label: "Karte 3 — Name", labelEn: "Card 3 — name", kind: "text", target: { key: "name_3" }, def: "Lara S." },
      { id: "rate_3", label: "Karte 3 — Sterne (1–5)", labelEn: "Card 3 — stars", kind: "text", target: { key: "rate_3" }, def: "5" },
      { id: "tag_4", label: "Karte 4 — Produkt-Label", labelEn: "Card 4 — product label", kind: "text", target: { key: "tag_4" }, def: "Angebot" },
      { id: "quote_4", label: "Karte 4 — Text", labelEn: "Card 4 — text", kind: "textarea", target: { key: "quote_4" }, def: "Super Preis-Leistung, sehr zufrieden. Ich bestelle gerne wieder." },
      { id: "name_4", label: "Karte 4 — Name", labelEn: "Card 4 — name", kind: "text", target: { key: "name_4" }, def: "Sandra L." },
      { id: "rate_4", label: "Karte 4 — Sterne (1–5)", labelEn: "Card 4 — stars", kind: "text", target: { key: "rate_4" }, def: "5" },
      { id: "tag_5", label: "Karte 5 — Produkt-Label", labelEn: "Card 5 — product label", kind: "text", target: { key: "tag_5" }, def: "Favorit" },
      { id: "quote_5", label: "Karte 5 — Text", labelEn: "Card 5 — text", kind: "textarea", target: { key: "quote_5" }, def: "Schnell geliefert, top verpackt — von mir gibt es fünf Sterne." },
      { id: "name_5", label: "Karte 5 — Name", labelEn: "Card 5 — name", kind: "text", target: { key: "name_5" }, def: "Elise A." },
      { id: "rate_5", label: "Karte 5 — Sterne (1–5)", labelEn: "Card 5 — stars", kind: "text", target: { key: "rate_5" }, def: "4" },
      { id: "tag_6", label: "Karte 6 — Produkt-Label (leer = aus)", labelEn: "Card 6 — product label (empty = off)", kind: "text", target: { key: "tag_6" }, def: "" },
      { id: "quote_6", label: "Karte 6 — Text", labelEn: "Card 6 — text", kind: "textarea", target: { key: "quote_6" }, def: "" },
      { id: "name_6", label: "Karte 6 — Name", labelEn: "Card 6 — name", kind: "text", target: { key: "name_6" }, def: "" },
      { id: "rate_6", label: "Karte 6 — Sterne (1–5)", labelEn: "Card 6 — stars", kind: "text", target: { key: "rate_6" }, def: "5" },
    ],
    presets: [
      { id: "google", label: "Google", labelEn: "Google", hint: "Bunter Google-Schriftzug, weiße Karten", settings: { brand: "google", star_color: "#f5a623", accent_color: "#4285F4" } },
      { id: "trustpilot", label: "Trustpilot", labelEn: "Trustpilot", hint: "Grüner Trustpilot-Look", settings: { brand: "trustpilot", star_color: "#00b67a", accent_color: "#00b67a" } },
      { id: "pur", label: "Neutral", labelEn: "Plain", hint: "Ohne Marken-Logo, in der Palette", settings: { brand: "pur", star_color: "@accent", accent_color: "@accent" } },
    ],
  },
  {
    type: "bro-circle-gallery",
    category: "media",
    label: "Kreis-Galerie",
    labelEn: "Circle gallery",
    desc: "Reihe runder Produktbilder mit Farbverlauf-Ringen — optional als Laufband. Zeigt Vielfalt/Sortiment auf einen Blick.",
    descEn: "A row of round product images with gradient rings — optionally an auto-scrolling marquee. Shows range at a glance.",
    fields: [
      { id: "heading", label: "Überschrift (optional)", labelEn: "Heading (optional)", kind: "text", target: { key: "heading" }, def: "" },
    ],
    presets: [
      { id: "verlauf", label: "Farbverlauf", labelEn: "Gradient", hint: "Lila→Orange-Ringe wie im Referenz-Look", settings: { ring: "verlauf", motion: "static", ring_from: "#7c3aed", ring_to: "#f59e0b" } },
      { id: "akzent", label: "Akzent", labelEn: "Accent", hint: "Ringe in der Akzentfarbe", settings: { ring: "akzent", motion: "static", accent_color: "@accent" } },
      { id: "weich", label: "Dezent", labelEn: "Soft", hint: "Zarte, dünne Ringe", settings: { ring: "weich", motion: "static" } },
      { id: "laufband", label: "Laufband", labelEn: "Marquee", hint: "Auto-Scroll mit Verlaufs-Ringen", settings: { ring: "verlauf", motion: "marquee", ring_from: "#7c3aed", ring_to: "#f59e0b" } },
    ],
  },
  {
    type: "bro-transformation",
    category: "social",
    label: "Transformation",
    labelEn: "Transformation",
    desc: "Zwei schräg gestapelte Vorher/Nachher-Fotos mit handgezeichneten Pfeilen + Testimonial mit Sternen und Zähler. Starker Ergebnis-Beweis.",
    descEn: "Two tilted before/after photos with hand-drawn arrows + a testimonial with stars and a counter. Strong proof of results.",
    fields: [
      { id: "label_from", label: "Notiz oben", labelEn: "Note (top)", kind: "text", target: { key: "label_from" }, def: "vorher" },
      { id: "label_to", label: "Notiz unten", labelEn: "Note (bottom)", kind: "text", target: { key: "label_to" }, def: "nachher" },
      { id: "heading", label: "Überschrift", labelEn: "Heading", kind: "text", target: { key: "heading" }, def: "Wow. Wirklich so gut." },
      { id: "text", label: "Bewertungstext", labelEn: "Review text", kind: "textarea", target: { key: "text" }, def: "Dieses Produkt hat den Raum komplett verändert — eine Eleganz und Wärme, die alles andere erst zusammenbringt." },
      { id: "pager", label: "Zähler (leer = aus)", labelEn: "Counter (empty = off)", kind: "text", target: { key: "pager" }, def: "1 / 4" },
    ],
    presets: [
      { id: "creme", label: "Creme", labelEn: "Cream", hint: "Warmer Creme-Hintergrund wie im Referenz-Look", settings: { bg: "#f3ecdf", text_color: "#2a2622", accent_color: "#c79a5b", star_color: "#c79a5b" } },
      { id: "weiss", label: "Weiß", labelEn: "White", hint: "Cleaner weißer Hintergrund", settings: { bg: "#ffffff", text_color: "#20242a", accent_color: "@accent", star_color: "@accent" } },
      { id: "akzent", label: "Akzent", labelEn: "Accent", hint: "Zart getönt in der Palette", settings: { bg: "@accentSoft", text_color: "#20242a", accent_color: "@accent", star_color: "@accent" } },
    ],
  },
  {
    type: "bro-compare-slider",
    category: "social",
    label: "Vorher-Nachher-Slider",
    labelEn: "Before/after slider",
    desc: "Ziehbarer Vorher/Nachher-Bildvergleich neben Headline mit hervorgehobener Zahl, Haken-Vorteilen und Trustpilot-Bewertung. Beweis + Nutzen kombiniert.",
    descEn: "A draggable before/after image slider next to a headline with a highlighted number, checkmark benefits and a Trustpilot review. Proof + benefits combined.",
    fields: [
      { id: "label_before", label: "Label „Vorher“", labelEn: "Label 'before'", kind: "text", target: { key: "label_before" }, def: "Vorher" },
      { id: "label_after", label: "Label „Nachher“", labelEn: "Label 'after'", kind: "text", target: { key: "label_after" }, def: "Nachher" },
      { id: "heading_pre", label: "Überschrift — Teil 1", labelEn: "Heading — part 1", kind: "text", target: { key: "heading_pre" }, def: "Werde Teil von" },
      { id: "heading_mark", label: "Hervorgehobene Zahl", labelEn: "Highlighted number", kind: "text", target: { key: "heading_mark" }, def: "1,5 Mio.+" },
      { id: "heading_post", label: "Überschrift — Teil 2", labelEn: "Heading — part 2", kind: "text", target: { key: "heading_post" }, def: "Menschen" },
      { id: "text", label: "Beschreibung", labelEn: "Description", kind: "textarea", target: { key: "text" }, def: "Erreiche das Ergebnis, das du dir immer gewünscht hast — für einen Effekt, der lange hält." },
      { id: "bullet_1", label: "Vorteil 1", labelEn: "Benefit 1", kind: "text", target: { key: "bullet_1" }, def: "Langanhaltendes Ergebnis" },
      { id: "bullet_2", label: "Vorteil 2", labelEn: "Benefit 2", kind: "text", target: { key: "bullet_2" }, def: "Intensiver Glanz & Weichheit" },
      { id: "bullet_3", label: "Vorteil 3", labelEn: "Benefit 3", kind: "text", target: { key: "bullet_3" }, def: "Für die meisten Typen geeignet" },
      { id: "bullet_4", label: "Vorteil 4 (leer = aus)", labelEn: "Benefit 4 (empty = off)", kind: "text", target: { key: "bullet_4" }, def: "" },
      { id: "review_title", label: "Bewertung — Titel", labelEn: "Review — title", kind: "text", target: { key: "review_title" }, def: "Absolut lebensverändernd" },
      { id: "review_text", label: "Bewertung — Text", labelEn: "Review — text", kind: "textarea", target: { key: "review_text" }, def: "Ein echter Game-Changer. Das Ergebnis ist unglaublich — genau so, wie ich es mir immer erträumt habe." },
      { id: "review_name", label: "Bewertung — Name", labelEn: "Review — name", kind: "text", target: { key: "review_name" }, def: "Sarah J." },
    ],
    presets: [
      { id: "hell", label: "Hell", labelEn: "Light", hint: "Weiß mit blauen Haken (Referenz-Look)", settings: { look: "hell", check_color: "#2563eb", mark_color: "#2537d8", accent_color: "#2f6df6" } },
      { id: "akzent", label: "Akzent", labelEn: "Accent", hint: "Haken & Zahl in der Palette", settings: { look: "akzent", check_color: "@accent", mark_color: "@accent", accent_color: "@accent" } },
...
export const STYLE_COMPOSITIONS: Record<string, CompositionEntry[]> = {
  ...
  sport: [
    ...
    { type: "bro-feature-grid", presetId: "kacheln" },
    { type: "bro-compare-slider", presetId: "hell" },
    { type: "bro-gradient-cta", presetId: "deep" },
  ],
  fresh: [
  ...
  spa: [
    ...
    { type: "bro-transformation", presetId: "creme" },
    { type: "bro-image-cards", presetId: "versetzt", settings: { sec_tone: "wash" } },
  ...
  deal: [
    ...
    { type: "bro-stats", presetId: "band" },
    { type: "bro-google-reviews", presetId: "trustpilot", settings: { sec_tone: "tint" } },
    { type: "bro-guarantee", presetId: "akzent" },
    { type: "qanda", presetId: "kompakt" },
    { type: "bro-gradient-cta", presetId: "mono" },
  ],
...
export const STYLE_COMPOSITION_EXTRAS: Record<string, CompositionEntry[]> = {
  ...
  elegant: [
    ...
    { type: "bro-steps", presetId: "timeline" },
    { type: "bro-transformation", presetId: "weiss" },
  ],
  bold: [
    { type: "bro-problem-solution", presetId: "kontrast" },
    { type: "bro-stats", presetId: "band" },
    { type: "vids", presetId: "dunkel" },
    { type: "bro-compare-slider", presetId: "dunkel" },
  ],
  playful: [
    { type: "bro-chat-reviews", presetId: "imessage" },
    { type: "collage", presetId: "links" },
  ...
  tech: [
    ...
    { type: "video", presetId: "standard" },
    { type: "bro-stats", presetId: "band" },
    { type: "bro-google-reviews", presetId: "trustpilot" },
  ],
  royal: [
  ...
  family: [
    ...
    { type: "multicolumn", presetId: "drei" },
    { type: "photo", presetId: "hell" },
    { type: "bro-google-reviews", presetId: "google" },
  ],
  carbon: [
    { type: "bro-feature-grid", presetId: "kompakt" },
    { type: "trustpilot", presetId: "flow" },
...
export const SECTION_ROLES: Record<string, SectionRole> = {
  ...
  "bro-circle-gallery": "story",
  "reviews2": "proof", "reviews": "proof", "bro-chat-reviews": "proof", "vids": "proof",
  "bro-spotlight": "proof", "bro-stats": "proof",
  "bro-google-reviews": "proof", "bro-transformation": "proof", "bro-compare-slider": "proof",
